...
// val schedule = Plan(lr)



// def GROUP_SIZE: Int = 10

// // def bruteForce_2_Old(la: Seq[Aircraft], s: Schedule): Option[Schedule] = la match
// //     case Nil => Some(s)
// //     case a +: remainingAircrafts => 
// //         val ls = s.runways.flatMap (
...
// //                             case Some(r) => bruteForce_2(remainingAircrafts, s.update(r))
// //                             case None => Nil
// //                     case _ => Nil
...
// //                     allPoss.minByOption(_.cost) match
// //                         case Some(r) => bruteForce_2(remainingAircrafts, s.update(r))
// //                         case None => bruteForce_2(remainingAircrafts, s.update(updatedRunway))
// //                 else
// //                     bruteForce_2(remainingAircrafts, s.update(updatedRunway))
// //             )
// //         )
// //         ls.minByOption(_.cost)

// // def bruteForce_Old(la: Seq[Aircraft], s: Schedule): Result[Schedule] = {
// //   val aircrafts = createGroups(la)
  
// //   def bruteForceHelper(aircrafts: Seq[Seq[Aircraft]], schedule: Schedule): Result[Schedule] = aircrafts match {
// //     case Nil => Right(schedule)
// //     case aircraftList +: remainingAircrafts =>
// //       bruteForce_2(aircraftList, schedule) match {
...
// for
//     agenda <- AgendaIO("files\\assessment\\ms01\\valid10_in.xml")
//     schedu <- bruteForce(agenda)
//     xml <- Right(ScheduleIO.scheduleToXml(schedu))
// yield xml


// // bruteForce(la, schedule) match
// //     case Right(s) => 
// //         Right(
